...
CREATE TABLE `meta` (
  ...
  `update_check_enabled` tinyint NOT NULL DEFAULT '0',
  `update_last_checked` datetime DEFAULT NULL,
  `update_latest_version` varchar(32) DEFAULT NULL,
  `update_branch` varchar(32) DEFAULT NULL,
